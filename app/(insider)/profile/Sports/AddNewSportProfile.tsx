    ...
    <View style={constStyles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={{ marginBottom: 20, marginTop: 20, alignItems: "center" }}>
          <Text style={styles.headingText}>Add New Sports Profile</Text>
        </View>
        ...
        <View>
          ...
          />
          <Text style={constStyles.labelText}>Position / Best At</Text>
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              <View style={styles.mediaPreview}>
                ...
                >
                  <FontAwesome name="remove" size={24} color={colors.primary} />
                </Text>
              </View>
            )}
          />
